...
func (in *AmaltheaSessionSpec) DeepCopyInto(out *AmaltheaSessionSpec) {
	*out = *in
	...
	if in.RcloneDataSource != nil {
		in, out := &in.RcloneDataSource, &out.RcloneDataSource
		*out = new(RcloneDataSource)
		(*in).DeepCopyInto(*out)
	}
...
func (in *AmaltheaSessionStatus) DeepCopyInto(out *AmaltheaSessionStatus) {
	*out = *in
	...
	in.WillHibernateAt.DeepCopyInto(&out.WillHibernateAt)
}
...
func (in *Culling) DeepCopyInto(out *Culling) {
	*out = *in
	...
	out.CPUIdleThreshold = in.CPUIdleThreshold.DeepCopy()
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RcloneDataSource) DeepCopyInto(out *RcloneDataSource) {
	*out = *in
	...
	if in.ConfigPasswordSecret != nil {
		in, out := &in.ConfigPasswordSecret, &out.ConfigPasswordSecret
		*out = new(SessionSecretKeyRef)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RcloneDataSource.
func (in *RcloneDataSource) DeepCopy() *RcloneDataSource {
	if in == nil {
		return nil
	}
	out := new(RcloneDataSource)
