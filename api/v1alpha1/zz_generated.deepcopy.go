...
func (in *AmaltheaChildren) DeepCopyInto(out *AmaltheaChildren) {
	*out = *in
	if in.Ingress != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AmaltheaChildren.
func (in *AmaltheaChildren) DeepCopy() *AmaltheaChildren {
	if in == nil {
		return nil
	}
	out := new(AmaltheaChildren)
	in.DeepCopyInto(out)
	return out
}
