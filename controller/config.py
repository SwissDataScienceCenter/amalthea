...
SESSION_IDLE_CHECK_INTERVAL_SECONDS = int(
    os.getenv("SESSION_IDLE_CHECK_INTERVAL_SECONDS", 300)
)
SESSION_CULL_IDLE_THRESHOLD_SECONDS = int(
    os.getenv("SESSION_CULL_IDLE_THRESHOLD_SECONDS", 86400)
)
CPU_USAGE_MILICORES_IDLE_THRESHOLD = int(
    os.getenv("CPU_USAGE_MILICORES_IDLE_THRESHOLD", 200)
)
