...
KIND_CLUSTER ?= amalthea-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name amalthea-builder
	$(CONTAINER_TOOL) buildx use amalthea-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm amalthea-builder
	rm Dockerfile.cross
