...
//+kubebuilder:rbac:groups=amalthea.dev,resources=jupyterservers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=amalthea.dev,resources=jupyterservers/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=amalthea.dev,resources=jupyterservers/finalizers,verbs=update
...
func (r *JupyterServerReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&amaltheav1alpha1.JupyterServer{}).
		Complete(r)
}
